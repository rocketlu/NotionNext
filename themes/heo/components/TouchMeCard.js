...
export default function TouchMeCard() {
  ...
  return (
        <div className={'relative h-28 text-white flex flex-col'}>
            ...
            <FlipCard
                className='cursor-pointer lg:p-6 p-4 border rounded-l bg-[#4f65f0] dark:bg-blue-600 dark:border-gray-600'
                frontContent={
                    <div className='h-full'>
                        <h2 className='font-[1000] text-2xl'>{siteConfig('HEO_SOCIAL_CARD_TITLE_1', null, CONFIG)}</h2>
