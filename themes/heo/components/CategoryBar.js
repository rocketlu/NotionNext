...
const MenuItem = ({ href, name }) => {
  ...
  return <div className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-white hover:bg-indigo-600 dark:hover:bg-blue-600 ${selected ? 'text-white bg-indigo-600 dark:bg-blue-600' : ''}`}>
