        ...
        <div id='tags-group' className='dark:border-gray-700 space-y-2'>
            {
                tags.map((tag, index) => {
                  return <Link passHref
                        ...
                        <div className={`${className || ''}  flex items-center hover:bg-indigo-600 dark:hover:bg-indigo-600 hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all`}>
