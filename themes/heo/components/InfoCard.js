        ...
        <Card className='bg-[#4f65f0] dark:bg-blue-600 text-white flex flex-col w-72 overflow-hidden relative'>
            ...
            <div className='flex justify-between'>
                <div className='flex space-x-3  hover:text-black dark:hover:text-white'>
                    {/* 两个社交按钮 */}
                    <div className='bg-indigo-400 p-2 rounded-full w-10 h-10 transition-colors duration-200 dark:bg-blue-500 dark:hover:bg-black hover:bg-white'>
...
function GreetingsWords() {
  ...
  return <div onClick={handleChangeGreeting} className=' select-none cursor-pointer py-1 px-2 bg-indigo-400 hover:bg-indigo-50  hover:text-indigo-950 dark:bg-blue-500 dark:hover:text-white dark:hover:bg-black text-sm rounded-lg  duration-200 transition-colors'>
        {greeting}
    </div>
}
...
function MoreButton() {
  return <Link href='/about'>
        <div className={'group bg-indigo-400 dark:bg-blue-500 hover:bg-white dark:hover:bg-black hover:text-black dark:hover:text-white flex items-center transition-colors duration-200 py-2 px-3 rounded-full space-x-1'}>
